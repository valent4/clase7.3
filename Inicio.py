...
# Imagen relacionada con la Fórmula 1 (puedes usar una imagen de la red o subir una propia)
st.image("https://upload.wikimedia.org/wikipedia/commons/0/01/Formula_1_Logo_2018.svg", caption="Logo oficial de la Fórmula 1", width=400)
...
# Imagen de un coche de Fórmula 1 en acción
st.image("https://upload.wikimedia.org/wikipedia/commons/6/69/Ferrari_F1-75_SF75_Monaco_GP_2022.jpg", caption="Un coche de Fórmula 1 en acción", width=700)
...
# Imagen de un coche de Fórmula 1 en el pit stop
st.image("https://upload.wikimedia.org/wikipedia/commons/e/e1/Ferrari_F1_2017_pit_stop.jpg", caption="Pit stop en una carrera de Fórmula 1", width=700)
...
# Imagen de un pit stop rápido
st.image("https://upload.wikimedia.org/wikipedia/commons/7/79/Pit_stop_by_McLaren_F1_team_in_2017.jpg", caption="Pit stop en una carrera de Fórmula 1", width=700)
